...
public class SawmillRecipeFactory {

    private final ResourceLocation name;
    private JsonObject json;

    public SawmillRecipeFactory(ResourceLocation name, JsonObject json) {
        this.name = name;
        this.json = json;
    }

    public ISawmillRecipe create(JsonContext context) {

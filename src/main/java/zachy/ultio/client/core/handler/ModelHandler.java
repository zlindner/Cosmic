...
public class ModelHandler {
    ...
    public static void registerItemBlock(Block block, int max, IntFunction<String> metaToPath) {
        for (int i = 0; i < max; i++) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), i, new ModelResourceLocation(Lib.MOD_ID + ":" + metaToPath.apply(i), "inventory"));
        }
    }
}
